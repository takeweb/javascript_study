...
function formatDateTime(date) {
    const options = {
        dateStyle: 'full',     // 日付のスタイル：short / medium / long / full
        timeStyle: 'full',     // 時刻のスタイル：short / medium / long / full
    }
...
document.querySelector("#result2").textContent = formatDateTime(date);
